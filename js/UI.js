...
function exitFullscreen() {
  ...
  /* Firefox */ else if (document.webkitExitFullscreen)
    document.webkitExitFullscreen();
  /* Chrome, Safari & Opera */ else if (document.msExitFullscreen)
...
function leftMenuTrocLivre() {
  ...
  animateCameraToPosition(
    ...
    speed1,
    frameCount,
    new BABYLON.Vector3(15.9, 7.5, -1.7)
  );
...
function leftMenuBloomberg() {
  ...
  animateCameraToPosition(
    ...
    speed1,
    frameCount,
    new BABYLON.Vector3(6.6, 6.2, -1.6)
  );
  ...
  animateCameraTargetToPosition(
    ...
    speed2,
    frameCount,
    new BABYLON.Vector3(12.44, 0.75, 7.4)
  );
...
function leftMenuPrinter() {
  ...
  animateCameraToPosition(
    ...
    speed1,
    frameCount,
    new BABYLON.Vector3(0, 8.2, 2.75)
  );
...
function leftMenuDeltakosh() {
  ...
  animateCameraToPosition(
    ...
    speed1,
    frameCount,
    new BABYLON.Vector3(8.8, 1.7, 1.7)
  );
  ...
  animateCameraTargetToPosition(
    ...
    speed2,
    frameCount,
    new BABYLON.Vector3(11.51, 1.05, 4.3)
  );
